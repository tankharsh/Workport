    ...
    return (
        <>
            ...
            <div className="bg-[#192B3C] w-full text-white text-3xl font-bold p-4 mt-2">
                ...
                <div className="bg-gray-200 w-full md:w-[65%] text-black p-4 rounded-lg shadow-md flex flex-col md:flex-row gap-10 mt-4">
                    {/* Image Placeholder */}
                    <img
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mt-10">
                            <button
                                ...
                                className="relative flex h-[50px] w-40 items-center justify-center overflow-hidden bg-blue-800 text-white shadow-2xl transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-blue-600 before:duration-500 before:ease-out hover:shadow-blue-600 hover:before:h-56 hover:before:w-56"
                            >
                            ...
                            <button
                                id="user-dashboard-whatsapp"
                                className="relative flex h-[50px] w-40 items-center justify-center overflow-hidden bg-green-600 text-white shadow-2xl transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-green-700 before:duration-500 before:ease-out hover:shadow-green-700 hover:before:h-56 hover:before:w-56"
                            >
                                <span className="relative z-10 text-lg flex justify-center items-center gap-2">
                                    <span>
                                        <FaWhatsapp />
                            ...
                            <button
                                id="user-dashboard-book"
                                className="relative flex h-[50px] w-40 items-center justify-center overflow-hidden bg-yellow-500 text-white shadow-2xl transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-yellow-600 before:duration-500 before:ease-out hover:shadow-yellow-600 hover:before:h-56 hover:before:w-56"
                            >
                                <span className="relative z-10 text-lg flex justify-center items-center gap-2">
                                    <span>
                                        <FaCheckCircle />
