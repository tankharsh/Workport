...
const Layout = () => {
  ...
  return (
    <>
      ...
      <div className="w-[calc(100%-45px)]  h-[50vh] m-5 ">
        <Slider {...settings}>
          {images.map((image, index) => (
            <div key={index} className="flex justify-center items-center h-full">
              <img src={image} alt={`Slide ${index + 1}`} className="w-full h-[50vh] object-cover bg-cover " />
            </div>
          ))}
        </Slider>
      </div>
      ...
      {/* Top Categories */}
      <div className='pt-9'>
        <div className="w-[calc(100%-45px)] m-5">
          {/* Top Categories Heading */}
          <h2 className="text-center text-2xl font-bold mb-4 flex flex-col items-center bg-white w-[18%] ml-[41%] font-[Poppines] ">
            Top Categories
